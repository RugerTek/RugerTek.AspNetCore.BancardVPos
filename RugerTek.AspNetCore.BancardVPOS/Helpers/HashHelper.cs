...
namespace RugerTek.AspNetCore.BancardVPOS.Helpers
{
    ...
    {
        public static string SingleBuy(string privateKey, int shopProcessId, decimal amount, string currency)
        {
            return CreateMd5($"{privateKey}{shopProcessId}{amount:F2}{currency}");
        }

        public static string SingleBuyConfirm(string privateKey, int shopProcessId, decimal amount, string currency)
        {
        ...
        public static string Charge(string privateKey, int shopProcessId, decimal amount, string currency, string aliasToken)
        {
